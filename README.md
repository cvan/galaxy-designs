...
Milestone | Type | Task | Assignee | Issue | Pull request | Status
--------- | ---- | ---- | -------- | ----- | ------------ | ------
v0 | API | Have feedback modal endpoint accept URL-encoded strings | [@at-kevinlau](https://github.com/at-kevinlau) | [cvan/galaxy#163](https://github.com/cvan/galaxy-api/issues/163) |  | in progress
...
Milestone | Type | Task | Assignee | Issue | Pull request | Status
--------- | ---- | ---- | -------- | ----- | ------------ | ------
v0 | UI | Implement UI for Developer Dashboard (My Games) | [@CharlesChong](https://github.com/CharlesChong) | [cvan/galaxy#99](https://github.com/cvan/galaxy/issues/99) | | previous design merged
...
v0 | API | Pending Game Queue Position | [@CharlesChong](https://github.com/CharlesChong) | [cvan/galaxy-api#162](https://github.com/cvan/galaxy-api/issues/162) | | in progress |
